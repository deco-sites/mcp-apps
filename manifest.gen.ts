...
import * as $$$0 from "./loaders/VTEX DOCS/VTEX DOCS/GET/apiCatalogPvtProduct:productId.ts";
import * as $$$1 from "./loaders/VTEX DOCS/VTEX DOCS/GET/apiCheckoutPubOrderForm.ts";
import * as $$$2 from "./loaders/VTEX DOCS/VTEX DOCS/POST/apiCatalogPvtProduct.ts";
import * as $$$3 from "./loaders/VTEX DOCS/VTEX DOCS/POST/apiCheckoutPubOrderForm:orderFormIdItems.ts";
...
const manifest = {
  "loaders": {
    "site/loaders/VTEX DOCS/VTEX DOCS/GET/apiCatalogPvtProduct:productId.ts":
      $$$0,
    "site/loaders/VTEX DOCS/VTEX DOCS/GET/apiCheckoutPubOrderForm.ts": $$$1,
    "site/loaders/VTEX DOCS/VTEX DOCS/POST/apiCatalogPvtProduct.ts": $$$2,
    "site/loaders/VTEX DOCS/VTEX DOCS/POST/apiCheckoutPubOrderForm:orderFormIdItems.ts":
      $$$3,
