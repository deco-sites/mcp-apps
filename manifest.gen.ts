...
import * as $$$1 from "./loaders/Loja integrada api/Loja integrada api/GET/v1Categoria:id.ts";
import * as $$$0 from "./loaders/Loja integrada api/Loja integrada api/GET/v1Categoria.ts";
import * as $$$3 from "./loaders/Loja integrada api/Loja integrada api/GET/v1Pedido:id.ts";
import * as $$$2 from "./loaders/Loja integrada api/Loja integrada api/GET/v1Pedido.ts";
import * as $$$5 from "./loaders/Loja integrada api/Loja integrada api/GET/v1Produto:id.ts";
import * as $$$4 from "./loaders/Loja integrada api/Loja integrada api/GET/v1Produto.ts";
import * as $$$6 from "./loaders/Loja integrada api/Loja integrada api/GET/v1SituacaoPedido.ts";
import * as $$$7 from "./loaders/Loja integrada api/Loja integrada api/POST/v1Produto.ts";
import * as $$$8 from "./loaders/Loja integrada api/Loja integrada api/PUT/v1Produto:id.ts";
...
const manifest = {
  "loaders": {
    "site/loaders/Loja integrada api/Loja integrada api/GET/v1Categoria:id.ts":
      $$$1,
    "site/loaders/Loja integrada api/Loja integrada api/GET/v1Categoria.ts":
      $$$0,
    "site/loaders/Loja integrada api/Loja integrada api/GET/v1Pedido:id.ts":
      $$$3,
    "site/loaders/Loja integrada api/Loja integrada api/GET/v1Pedido.ts": $$$2,
    "site/loaders/Loja integrada api/Loja integrada api/GET/v1Produto:id.ts":
      $$$5,
    "site/loaders/Loja integrada api/Loja integrada api/GET/v1Produto.ts": $$$4,
    "site/loaders/Loja integrada api/Loja integrada api/GET/v1SituacaoPedido.ts":
      $$$6,
    "site/loaders/Loja integrada api/Loja integrada api/POST/v1Produto.ts":
      $$$7,
    "site/loaders/Loja integrada api/Loja integrada api/PUT/v1Produto:id.ts":
      $$$8,
