...
import * as $$$0 from "./loaders/RenderCV/RenderCV/DELETE/resume:resumeId.ts";
import * as $$$1 from "./loaders/RenderCV/RenderCV/GET/resume:resumeId.ts";
import * as $$$2 from "./loaders/RenderCV/RenderCV/GET/resume:resumeIdHtml.ts";
import * as $$$3 from "./loaders/RenderCV/RenderCV/GET/resume:resumeIdPdf.ts";
import * as $$$4 from "./loaders/RenderCV/RenderCV/GET/resumes.ts";
import * as $$$5 from "./loaders/RenderCV/RenderCV/GET/styles.ts";
import * as $$$6 from "./loaders/RenderCV/RenderCV/POST/resumes.ts";
import * as $$$7 from "./loaders/RenderCV/RenderCV/PUT/resume:resumeId.ts";
...
const manifest = {
  "loaders": {
    "site/loaders/RenderCV/RenderCV/DELETE/resume:resumeId.ts": $$$0,
    "site/loaders/RenderCV/RenderCV/GET/resume:resumeId.ts": $$$1,
    "site/loaders/RenderCV/RenderCV/GET/resume:resumeIdHtml.ts": $$$2,
    "site/loaders/RenderCV/RenderCV/GET/resume:resumeIdPdf.ts": $$$3,
    "site/loaders/RenderCV/RenderCV/GET/resumes.ts": $$$4,
    "site/loaders/RenderCV/RenderCV/GET/styles.ts": $$$5,
    "site/loaders/RenderCV/RenderCV/POST/resumes.ts": $$$6,
    "site/loaders/RenderCV/RenderCV/PUT/resume:resumeId.ts": $$$7,
